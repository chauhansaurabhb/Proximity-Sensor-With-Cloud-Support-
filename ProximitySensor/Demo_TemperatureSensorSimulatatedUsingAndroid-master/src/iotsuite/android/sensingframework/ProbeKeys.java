...
public class ProbeKeys {
	...
	public static interface StatusKeys {
		public static final String STATUSEVENT = "status";
		public static final String ENABLED = "ENABLED", RUNNING = "RUNNING",
				NEXT_RUN = "NEXT_RUN", PREVIOUS_RUN = "PREVIOUS_RUN",
	...
	public static interface BaseProbeKeys {
		...
		public static final String PROBE = "probe", TIMESTAMP = "timestamp";

	}

	public static interface SensorKeys extends BaseProbeKeys {
		public static final String MAXIMUM_RANGE = "maximumRange",
				NAME = "name", POWER = "power", RESOLUTION = "resolution",
				TYPE = "type", VENDOR = "vendor", VERSION = "version",
				SENSOR = "sensor", EVENT_TIMESTAMP = "eventTimestamp",
				ACCURACY = "accuracy";
	}

	public static interface AccelerometerFeaturesKeys extends BaseProbeKeys {
		public static final String ACCELEROMETERFEATURE = "accelerometerfeature";
		public static final String X = "x", Y = "y", Z = "z",
				DIFF_FRAME_SECS = "diffFrameSecs",
				NUM_FRAME_SAMPLES = "numFrameSamples", MEAN = "mean",
	...
	public static interface AudioFeaturesKeys extends BaseProbeKeys {
		public static final String DIFF_SECS = "diffSecs", L1_NORM = "l1Norm",
				L2_NORM = "l2Norm", LINF_NORM = "linfNorm",
				PSD_ACROSS_FREQUENCY_BANDS = "psdAcrossFrequencyBands",
				MFCCS = "mfccs";
	}

	public static interface AudioFilesKeys extends BaseProbeKeys,
	...
	public static interface BatteryKeys extends BaseProbeKeys {
		public static final String ICON_SMALL = "iconSmall",
				PRESENT = "present", SCALE = "scale", LEVEL = "level",
				TECHNOLOGY = "technology", STATUS = "status",
				VOLTAGE = "voltage", HEALTH = "health",
				TEMPERATURE = "temperature", PLUGGED = "plugged",
	...
	public static interface BluetoothKeys extends BaseProbeKeys {
		...
		NAME = "name", TYPE = "type", UUID = "uuid", ADDRESS = "address",
				DEVICES = "devices";
	}

	public static class BrowserBookmarksKeys extends
			android.provider.Browser.BookmarkColumns implements BaseProbeKeys {
		public static final String BOOKMARKS = "bookmarks";
	}

	public static class BrowserSearchesKeys extends
			android.provider.Browser.SearchColumns implements BaseProbeKeys {
		public static final String SEARCHES = "searches";
	}

	public static class CallLogKeys extends android.provider.CallLog.Calls
			implements BaseProbeKeys {
		public static final String CALLS = "calls";
	}

	public static interface CellKeys extends BaseProbeKeys {
		public static final String TYPE = "type", PSC = "psc", CID = "cid",
				LAC = "lac";
	...
	public static interface ContactKeys extends BaseProbeKeys {
		...
		// Cannot extend android final class
		// android.provider.ContactsContract.Data, or inherit from protected
		// interfaces
	}

	public static interface GravitySensorKeys extends SensorKeys {
		public static final String GravitySensorEvent = "gravity";
		public static final String X = "x", Y = "y", Z = "z";
	}

	public static interface GyroscopeSensorKeys extends SensorKeys {
		public static final String GyroscopeSensorEvent = "gyroscope";
		public static final String X = "x", Y = "y", Z = "z";
	}

	public static interface HardwareInfoKeys extends BaseProbeKeys {
		public static final String WIFI_MAC = "wifiMac",
				BLUETOOTH_MAC = "bluetoothMac", ANDROID_ID = "androidId",
				BRAND = "brand", MODEL = "model", DEVICE_ID = "deviceId",
				SERIAL = "serial", MANUFACTURER = "manufacturer",
				HOST = "host", OS_VERSION = "os", PRODUCT = "product",
				DEVICE_TYPE = "device type", PHONE_TYPE_NONE = "none",
				PHONE_TYPE_GSM = "gsm", PHONE_TYPE_CDMA = "cdma",
				PHONE_TYPE_SIP = "sip", OS_BUILD_NUMBER = "os-build-number",
				MODE = "mode", MODE_NORMAL = "normal", MODE_SILENT = "silent",
	...
	public static interface ImagesKeys extends BaseProbeKeys,
			android.provider.MediaStore.Images.ImageColumns {
		public static final String IMAGES = "images";
	}

	public static interface LightSensorKeys extends SensorKeys {
		public static final String LightSensorEvent = "light";
		public static final String LUX = "lux";
	}

	public static interface LinearAccelerationSensorKeys extends SensorKeys {
		public static final String LinearAccelerationSensorEvent = "linearAcceleration";
		public static final String X = "x", Y = "y", Z = "z";
	}
	...
	public static interface MagneticFieldSensorKeys extends SensorKeys {
		public static final String MagneticFieldSensorEvent = "magneticfield";
		public static final String X = "x", Y = "y", Z = "z";
	}

	public static interface OrientationSensorKeys extends SensorKeys {
		public static final String OrientationSensorEvent = "orientation";
		public static final String AZIMUTH = "azimuth", PITCH = "pitch",
				ROLL = "roll";
	}

	public static interface PressureSensorKeys extends SensorKeys {
		public static final String PressureSensorEvent = "pressure";
		public static final String PRESSURE = "pressure";
	}

	public static interface ProximitySensorKeys extends SensorKeys {
		public static final String ProximitySensorEvent = "proximity";
		public static final String DISTANCE = "distance";
	}

	public static interface RotationVectorSensorKeys extends SensorKeys {

		public static final String RotationVectorSensorEvent = "roationvector";
	...
	public static interface RunningApplicationsKeys extends BaseProbeKeys {
		public static final String RUNNING_TASKS = "runningTasks",
				DURATION = "duration", TASK_INFO = "taskInfo";
	}

	public static interface ScreenKeys extends BaseProbeKeys {
		public static final String ScreenEvent = "screenOn";
		public static final String SCREEN_ON = "screenOn";
	}

	public static interface SmsKeys extends BaseProbeKeys,
			AndroidInternal.TextBasedSmsColumns {
		// public static final String
	}
	...
	public static interface TelephonyKeys extends BaseProbeKeys {
		public static final String CALL_STATE = "callState",
				...
				NETWORK_TYPE = "networkType", PHONE_TYPE = "phoneType",
				SIM_COUNTRY_ISO = "simCountryIso",
				SIM_OPERATOR = "simOperator",
				SIM_OPERATOR_NAME = "simOperatorName",
				SIM_SERIAL_NUMBER = "simSerialNumber", SIM_STATE = "simState",
	...
	public static interface TemperatureSensorKeys extends SensorKeys {
		...
		public static final String TemperatureSensorEvent = "temperature";
	...
	public static interface VideosKeys extends BaseProbeKeys,
			android.provider.MediaStore.Video.VideoColumns {
		public static final String VideoEvent = "video";
	...
	public static interface AccountsKeys extends BaseProbeKeys {
		public static final String ACCOUNTS = "accounts", NAME = "name",
				TYPE = "type";
	}
	...
	public interface AndroidInternal {
		...
		public interface TextBasedSmsColumns {
			...
			public static final int MESSAGE_TYPE_FAILED = 5; // for failed
																// outgoing
																// messages
			public static final int MESSAGE_TYPE_QUEUED = 6; // for messages to
																// send later
			...
			/**
			 * Indicates whether this message has been seen by the user. The
			 * "seen" flag will be used to figure out whether we need to throw
			 * up a statusbar notification or not.
			 */
			...
			/**
			 * Whether the <code>TP-Reply-Path</code> bit was set on this
			 * message
			 * <P>
			 * Type: BOOLEAN
			 * </P>
			...
			/**
			 * The service center (SC) through which to send the message, if
			 * present
			 * <P>
			 * Type: TEXT
			 * </P>
