...
public interface NameGenerator {
	...
	public static class DatetimeNameGenerator implements NameGenerator {
		@Override
		public String generateName(final String name) {
			String datetime = java.text.DateFormat.getDateTimeInstance()
					.format(new Date());
	...
	public static class CompositeNameGenerator implements NameGenerator {
		...
		public CompositeNameGenerator(NameGenerator... nameGenerators) {
			...
			System.arraycopy(nameGenerators, 0, this.nameGenerators, 0,
					nameGenerators.length);
		}
	...
	public static class SystemUniqueTimestampNameGenerator implements
			NameGenerator {

		private final NameGenerator delegate;

		public SystemUniqueTimestampNameGenerator(Context context) {
			delegate = new CompositeNameGenerator(new TimestampNameGenerator(),
					new ConstantNameGenerator(UuidUtil
							.getInstallationId(context) + "_", ""));
		}
